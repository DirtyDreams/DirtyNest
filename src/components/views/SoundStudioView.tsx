          ...
          <div>
            <div className="flex items-center gap-2">
              <h2 className="text-lg font-black tracking-tight text-[#F1F3F9]">
                SOUND STUDIO // <span className="text-[#BF40FF]">VOICE CLONING & DSP SYNTHESIZER</span>
              </h2>
            ...
            <p className="text-xs text-[#9499B3]">
              Zero-shot neural voice cloning, emotion inflection TTS & real-time Web Audio DSP rack
            </p>
          </div>
        </div>
