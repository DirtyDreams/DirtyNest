...
export const todos = pgTable("todos", {
  ...
  created_at: varchar("created_at", { length: 100 }).notNull().default(""),
});

export const notes = pgTable("notes", {
  id: serial("id").primaryKey(),
  content: text("content").notNull().default(""),
  updated_at: varchar("updated_at", { length: 100 }).notNull().default(""),
});
...
export const focusSessions = pgTable("focus_sessions", {
  ...
  completed_at: varchar("completed_at", { length: 100 }).notNull().default(""),
});
...
export const zbTopics = pgTable("zb_topics", {
  ...
  fetched_at: varchar("fetched_at", { length: 100 }).notNull().default(""),
});
...
export const zbQueue = pgTable("zb_queue", {
  ...
  created_at: varchar("created_at", { length: 100 }).notNull().default(""),
  approved_at: varchar("approved_at", { length: 100 }),
  published_at: varchar("published_at", { length: 100 }),
});
